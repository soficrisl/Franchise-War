...
public class Computer {
    ...
    public void simulation() {
        ...
        Memory.insertCharacter(new Character("Yoda", "https://example.com/yoda.jpg", 5, 0), 0);
        Memory.insertCharacter(new Character("Obi-Wan Kenobi", "https://example.com/obiwan.jpg", 5, 0), 0);
        ...
        Memory.insertCharacter(new Character("Poe Dameron", "https://example.com/poe.jpg", 3, 0), 0);
        ...
        Memory.insertCharacter(new Character("Jabba the Hutt", "https://example.com/jabba.jpg", 3, 0), 0);
        Memory.insertCharacter(new Character("General Grievous", "https://example.com/grievous.jpg", 5, 0), 0);
        
        // Star Trek Characters
        Memory.insertCharacter(new Character("Captain Kirk", "https://example.com/kirk.jpg", 5, 1), 1);
        ...
        Memory.insertCharacter(new Character("Hikaru Sulu", "https://example.com/hikarusulu.jpg", 1, 1), 1);
